        ...
        <Content>
          {
            details ? (
              <View style={{ backgroundColor: '#fff', position: 'relative' }}>
                ...
                <Image source={{ uri: `https://image.tmdb.org/t/p/w500${details.backdrop_path}` }} style={{ width: 500, height: 300 }} />
                <View>
                  <Icon ios='ios-star' android='md-star' />
                  <Text>{ details.vote_average }/10</Text>
                </View>
                <H1 style={{ paddingVertical: 10, textAlign: 'center' }}>{ details.title }</H1>
